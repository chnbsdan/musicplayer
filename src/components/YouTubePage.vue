  ...
  <div v-if="visible" class="page-overlay" @click="close">
    <div class="page-content" @click.stop>
      ...
      <div class="page-body">
        ...
        <div class="footer-tip">💡 在 YouTubePage.vue 的 videoItems 中增删改</div>
      </div>
    </div>
  </div>
</template>
...
// ============================================================
// 🔥 在这里添加你的 YouTube 视频链接
// ============================================================
const videoItems = [
  { id: 1, title: '示例视频 1', url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ' },
  { id: 2, title: '雲雀青君歸來', url: 'https://www.youtube.com/watch?v=7LgXKmKOSzc' },
  // 添加更多...
]
...
.item-icon { font-size: 16px; color: #ff0000; }
.item-title {
  font-size: 13px;
